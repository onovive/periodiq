  ...
  return (
    <div>
      <form onSubmit={handleSubmit} className="p-5 py-10 sm:p-24  text-black ">
        ...
        <div className="mt-5">
          <input type="city" placeholder={data?.city} name="city" value={formData.city} onChange={handleInputChange} className="w-full font-extralight px-3 py-4 text-base border border-[#e8eae8] rounded-lg  hover:border-[#017e48] focus:border-2 focus:border-[#017e48]" required />
        </div>
