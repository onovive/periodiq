                        ...
                        <Section title={game?.eventDetails?.eventDetailTitle}>
                          ...
                          <ul className="space-y-4 text-gray-700 text-sm sm:text-base">
                            ...
                            <li className="flex ">
                              <div className="w-5">
                                {" "}
                                <svg xmlns="http://www.w3.org/2000/svg" fillRule="evenodd" strokeLinejoin="round" strokeMiterlimit="1.414" clipRule="evenodd" viewBox="0 0 32 32" id="date">
