...
export default function Home({ data }: { data: any }) {
  ...
  return (
                    ...
                    <div className="grid grid-cols-1 gap-2 shadow-lg rounded-lg">
                      <div className="bg-gradient-to-r from-[#252625ce] to-[#232523] text-white rounded-lg shadow-md p-6 text-center">
                        ...
                        <Link target={'_blank'} href="/#register">
                          <button className="register-button bg-white text-[#232523] font-bold py-3 px-6 rounded-full hover:bg-[#bfbdbd] transition duration-300">
                            Register Now
                          </button>
                        </Link>
                      </div>
                        ...
                        <Section title="Event Details">
                          ...
                          <ul className="space-y-4 text-gray-700">
                            <li className="flex ">
                              ...
                              <strong className="ml-2 mr-2">Date:</strong> {game?.eventDetails?.time}
                            </li>
                            <li className="flex">
                              ...
                              <strong className="ml-2  mr-2">Time:</strong> {game?.eventDetails?.time}
                            </li>
                            <li className="flex">
                              <div className="w-5 h-5">
                              ...
                              <strong className="ml-2  mr-2">Location:</strong> {game?.eventDetails?.location}
                            </li>
                            <li className="flex">
                              <div className="w-5 h-5">
                              ...
                              <strong className="ml-2  mr-2">Duration:</strong> {game?.eventDetails?.duration}
                            </li>
                            <li className="flex">
                              <div className="w-5 h-5">
	...
	c-7.5-6.6-12-15.9-12.6-25.8C80.1,37,82.3,28.6,87.8,21.6z"
                              ...
                              <strong className="ml-2  mr-2">Difficulty:</strong> {game?.eventDetails?.difficulty}
                            </li>
                          </ul>
                        </Section>
                      </div>
