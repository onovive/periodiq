...
export default function Home() {
  return (
        ...
        <div className="grid gap-8 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2 space-y-8">
            <div className="w-full ">
              <h2 className="text-[32px] sm:text-[40px] leading-[48px] sm:leading-[56px] font-bold text-[#232523] mb-2">Company A Treasure Hunt</h2>
                ...
                <Section title="Event Details">
                  ...
                  <ul className="space-y-3 text-gray-700">
                    <li className="flex ">
                      ...
                      <strong className="ml-2 mr-2">Date:</strong> TBD
                    </li>
                    <li className="flex">
                      ...
                      <strong className="ml-2  mr-2">Time:</strong> 10:00 AM - 4:00 PM
                    </li>
                    <li className="flex">
                      <div className="w-5 h-5">
                      ...
                      <strong className="ml-2  mr-2">Location:</strong> Rome, Italy
                    </li>
                    <li className="flex">
                      <div className="w-5 h-5">
                      ...
                      <strong className="ml-2  mr-2">Duration:</strong> Approximately 6 hours
                    </li>
                    <li className="flex">
                      <div className="w-5 h-5">
	...
	c-7.5-6.6-12-15.9-12.6-25.8C80.1,37,82.3,28.6,87.8,21.6z"
                      ...
                      <strong className="ml-2  mr-2">Difficulty:</strong> Moderate
                    </li>
                  </ul>
                </Section>
              </div>
