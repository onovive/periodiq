...
export const serverComponents: any = {
  ...
  block: {
    ...
    h3: ({ children }: { children: any }) => <h3 className="text-[#232523] font-bold text-xl sm:text-2xl py-2">{children}</h3>,
    h4: ({ children }: { children: any }) => <h4 className="text-[#232523] font-bold text-lg sm:text-xl py-2">{children}</h4>,
