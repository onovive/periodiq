...
const Card = ({ blogData, lang }: { blogData: any; lang: any }) => {
  return (
    <section className="rounded-3xl overflow-hidden shadow-lg transition-transform transform border border-[#2325231a] hover:border-[#232523] max-h-[680px] lg:max-h-[550px] xl:max-h-[620px]">
